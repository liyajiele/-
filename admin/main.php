...
<body>
    <div class="header">
        <h2><?php echo $_SESSION["usename"]; ?>，欢迎来到内容管理系统！</h2>
        ...
        <ul>
            <li>
                ...
                <ul class="son">
                    ...
                    <li><a href="edituser.php" target="right">管理用户</a></li>
                </ul>
            </li>
            <li>
            ...
            <li>
            	<span class="opi">推荐位管理</span>
                <ul class="son">
                    <li><a href="addpos.php" target="right">添加推荐位</a></li>
                    <li><a href="updatep.php" target="right">管理推荐位</a></li>
                </ul>
            </li>
        </ul>
